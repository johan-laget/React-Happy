...
export const Footer = () => {
  return <footer className="bg-primary">
      <div className="container flex items-stretch justify-between text-primary-foreground"> 
        ...
        <img class="rounded-full w-40 h-40 " src={Logo} alt="image description"/>
        </div>
        <div className="flex-1 p-4">
          ...
          <ul>
            ...
            <li className=""><a href="#">Nos recettes</a></li>
            <li className=""><a href="#">Suggestions</a></li>
          </ul>
        </div>
        <div className="flex-1 p-4">
                <h2 className="mb-3">Coordonnées</h2>
                <ul>
            <li className=""><a href="#">Contactez-nous</a></li>
            <li className=""><a href="#">conditions général</a></li>
            <li className=""><a href="#">Mention Légal</a></li>
          </ul>
        </div>
      </div>
